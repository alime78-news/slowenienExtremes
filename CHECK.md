# EXTREMES  
### EXTREME_LANGUAGE  
:white_check_mark: EXTREME_LANGUAGE key exists (sl)  
### EXTREME_GH_TOKEN  
...
1. Goto https://github.com/orgs/alime78-news/people  
...
1. Please register with username (i.e.: alime78_news) at https://www.geonames.org/login  
2. Assign the choosen username as new organization secret at https://github.com/organizations/alime78-news/settings/secrets/actions/new  
   * Name:  **GEONAMES_KEY**   
...
3. Assign the API key as (new?) organization secret or edit it at https://github.com/organizations/alime78-news/settings/secrets/actions  
   * Name:  **RAPIDAPI_KEY**   
   * Value: **Your key here**   
